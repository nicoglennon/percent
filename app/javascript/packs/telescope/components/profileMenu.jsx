              ...
              <Transition
                ...
                { show => props =>
                  ...
                  >
                    ...
                    <Link to={`/@${this.props.username}/faq`}>
                      <p className="navbar-profileMenuOptions">FAQ</p>
                    </Link>
                    <Link to={`/@${this.props.username}/tour`}>
                      <p className="navbar-profileMenuOptions">Tour</p>
                    </Link>
