...
class WeekCard extends React.Component {
  ...
  render(){
    ...
    var color = ["hsla(",hue,",70%,50%, 1)"].join("");
    ...
    return(
      <li className="weekCard-li" key={this.props.weekObj.id} >
        <Link className="weekCard-alink" to={`/@${this.props.username}/weeks/${this.props.weekObj.id}`} style={{color: color, border: '1px solid ' + color, backgroundColor: "hsla(" + hue + ",85%,70%, " + backgroundOpacity + ")"}} onMouseOver={this.handleOnMouseHover} onMouseLeave={this.handleOnMouseLeave} >
